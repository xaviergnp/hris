<template>
    ...
    <AuthenticatedLayout>
        <div class="container py-4">
            <Link :href="route('recruitment.job_posting.index')">Back</Link>
            ...
            <form @submit.prevent="create">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" v-model="form.salary_grade" id="salary_grade">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" v-model="form.competency" id="competency">
