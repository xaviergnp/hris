...
<template>
  <section class="space-y-6">
    ...
    <div
      id="deleteAccountModal" class="modal fade" tabindex="-1" aria-labelledby="deleteAccountModalLabel"
      aria-hidden="true"
    >
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button
              type="button" class="btn btn-danger" :class="{ 'opacity-25': form.processing }"
