                ...
                <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="married"
                                            v-model="form.civil_status" name="civil_status" value="married" />
                                        <label class="form-check-label" for="married">Married</label>
                                    </div>
                                </div>
                                <div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="widowed"
                                            v-model="form.civil_status" name="civil_status" value="widowed" />
                                        <label class="form-check-label" for="widowed">Widowed</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="separated"
                                            v-model="form.civil_status" name="civil_status" value="separated" />
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="dual_citizenship"
                                    v-model="form.dual_citizenship" name="dual_citizenship"
                    ...
                    <div class="col-12 col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm"
                                v-model="form.r_address_subdivision_village" />
                    ...
                    <div class="col-12 col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm"
                                v-model="form.r_address_city_municipality" />
                    ...
                    <div class="col-12 col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" style="text-transform: none;" class="form-control form-control-sm"
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-end">
                            <div class="d-flex gap-2">
                                ...
                                <button type="submit" :disabled="!form.isDirty && form.wasSuccessful"
                                    class="btn btn-success">
                                    <Spinner :processing="form.processing" /> {{ !form.isDirty &&
                                        form.wasSuccessful ? 'Saved' : 'Save' }}
                                </button>
                                <Link :href="route('profile.pds.family_background.edit')" type="button"
