<template>
    <RolePermissionLayout>
        ...
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addRoleModal">Create Permission</button>
            ...
            <tbody>
                <tr v-for="permission in props.permissions.data">
                    ...
                    <td class="d-flex gap-2">
                        <Link :href="route('admin.role_permission.permission.edit', { permission: permission.id })"
                            class="btn btn-success">Edit</Link>
                        <Link class="btn btn-danger" method="delete"
                            :href="route('admin.role_permission.permission.destroy', { permission: permission.id })"
                            as="button">
                        Delete
                        </Link>
                    </td>
        ...
        <template #body>
            <form @submit.prevent="addPermission">
                <div class="form-group">
                    ...
                    <input type="text" name="" id="" class="form-control" v-model="addForm.permission_name" />
...
const addPermission = () => addForm.post(route('admin.role_permission.permission.store'), {
    onSuccess: () => {
